...
#define kProfileWH 40 // 头像宽高
#define kProfileWeith 50
#define kProfileHeight 40
...
@interface ChatMsgFrame : NSObject

@property (nonatomic, assign, readonly) CGRect profileF;
